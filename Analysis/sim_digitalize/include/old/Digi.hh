...
public:
    ...
    // Then it can be converted to IHEP structure and DPNC structure.
...
public:
    ...
    void clear_event();
    void energy_response(const vector<EventReader::HitsCol_T>& hitscol_vec, const Calib& calib_obj);

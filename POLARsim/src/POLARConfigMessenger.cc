...
POLARConfigMessenger::POLARConfigMessenger(POLARGlobalConfig* theGlobalConfig) {
...
POLARConfigMessenger::~POLARConfigMessenger() {
...
void POLARConfigMessenger::SetNewValue(G4UIcommand* command, G4String newValue) {
